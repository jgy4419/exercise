...
export default {
    data(){
        return{
            name: ['email', 'password', 'rePassword', 'name', 'tel', 'address', 'introduction', 'nickname'],
            label: ['이메일', '비밀번호', '비밀번호 재확인', '이름', '전화번호', '주소', '자기소개', '닉네임'],
            value: ['ex) user@naver.com (필수)', '비밀번호를 입력하세요 (필수)', '비밀번호를 한번 더 입력해주세요', '이름 (필수)', '전화번호 (필수)', '주소 (필수)', '자기소개', '닉네임'],
